...
public class LoginActivity extends AppCompatActivity {
    ...
    private void validateData() {
        /*Before login, let's do some validation*/
    ...
    private void checkUserType() {
        ...
        if (firebaseUser != null) {
            //check in db
            DatabaseReference ref = FirebaseDatabase.getInstance().getReference().child(firebaseUser.getUid());
            ref.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onCancelled(@NonNull DatabaseError error) {
                    progressDialog.dismiss();
                    Toast.makeText(LoginActivity.this, "Failed to check user type: " + error.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
